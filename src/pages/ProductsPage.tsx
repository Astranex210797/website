                ...
                <div className={`max-w-md ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  <div className="space-y-5">
                    <div>
                      ...
                      <p className="text-lg text-[#1ABC9C] italic mb-4">
                        {product.subtitle}
                      </p>
                      <p className="text-base text-[#0D3B2E] leading-relaxed">
                        {product.description}
                      </p>
                    </div>
      ...
      <section className="py-14 bg-gradient-to-r from-[#1ABC9C] to-[#145943] text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold mb-4 text-[#E6FAF4] drop-shadow-xl">
              Need Help Choosing?
            </h2>

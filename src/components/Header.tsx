...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-pearlescent/95 backdrop-blur-md shadow-sm border-b border-bottle-green-solid/10">
              ...
              <AnimatePresence>
                {activeDropdown === 'products' && (
                  <motion.div
                    ...
                    animate="visible"
                    exit="exit"
                    className="absolute top-full left-0 mt-3 w-64 bg-pearlescent rounded-xl shadow-lg border border-bottle-green-solid/20 py-2 overflow-hidden"
                  >
              ...
              <AnimatePresence>
                {activeDropdown === 'services' && (
                  <motion.div
                    ...
                    animate="visible"
                    exit="exit"
                    className="absolute top-full left-0 mt-3 w-48 bg-pearlescent rounded-xl shadow-lg border border-bottle-green-solid/20 py-2 overflow-hidden"
                  >
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="md:hidden bg-pearlescent-subtle border-t border-bottle-green-solid/20"
            >
